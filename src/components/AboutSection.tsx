        ...
        <div className="about-content">
          <div className="about-text">
            <p className="about-paragraph">
              ...
              My journey in programming started with curiosity and has evolved into a deep appreciation 
              for clean code, user experience, and problem-solving.
            </p>
            <p className="about-paragraph">
              I specialize in modern web technologies including React, JavaScript, Spring Boot, Python and various 
              frameworks that help bring ideas to life. I believe in writing code that is not only 
              functional but also maintainable and scalable.
            </p>
            <p className="about-paragraph">
              When I'm not coding, you can find me exploring new technologies, contributing to open-source 
              projects, or enjoying a good book about software architecture and design patterns.
            </p>
            <div className="tech-stack">
              ...
              <div className="tech-grid">
                ...
                <div className="tech-item">
                  <div className="tech-icon">
                    <svg viewBox="0 0 24 24" fill="currentColor">
                      <path d="M23.546 10.93L13.067.452c-.604-.603-1.582-.603-2.188 0L8.708 2.627l2.76 2.76c.645-.215 1.379-.07 1.889.441.516.515.658 1.258.438 1.9l2.658 2.66c.645-.223 1.387-.078 1.9.435.721.72.721 1.884 0 2.604-.719.719-1.881.719-2.6 0-.539-.541-.674-1.337-.404-1.996L12.86 8.955v6.525c.176.086.342.203.488.348.713.717.713 1.881 0 2.598-.719.719-1.896.719-2.613 0-.717-.717-.717-1.881 0-2.598.177-.18.387-.316.617-.426V8.835c-.23-.105-.44-.242-.617-.421-.545-.545-.676-1.342-.396-2.009L7.636 3.7.45 10.881c-.6.605-.6 1.584 0 2.189l10.48 10.477c.604.604 1.582.604 2.186 0l10.43-10.43c.605-.603.605-1.582 0-2.187"/>
                    </svg>
                  </div>
